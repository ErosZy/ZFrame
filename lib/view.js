...
//读取模板并解析，返回数据
View.prototype._readTpl = function(_filePath,_toParse,_fn){
    var self = this;
...
View.prototype._matchTplStr = function(_fn){
    var self = this,
        _str = self._str,
    ...
    if(_config.cache || self._cache){
        self._writeToFile(self._str,_serPath,_fn);
    }
...
//文件保存
View.prototype._writeToFile = function(_data,_filePath,_fn){
    var self = this,
